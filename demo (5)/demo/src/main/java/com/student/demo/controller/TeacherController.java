...
public class TeacherController {
    ...
    public List<TeacherDetailsDTO> getTeacher(){
        List<TeacherDetailsDTO> teacherList=teacherService.getTeacher();
    ...
    public TeacherDetailsDTO findTeacherbyId(@PathVariable long id) {
        TeacherDetailsDTO teacher;
        teacher=teacherService.getTeacher(id);
        return teacher;
     }
    @PostMapping
    public void registerNewTeacher(@RequestBody TeacherDetailsDTO teacherDto){
